...
from .views import PlayerListCreate, ProblemListCreate, PlayerDetailUpdate, RankListCreateAPIView, PlayerDetail, UserLoginAPIView, UserSignUpAPIView, LogoutView
...
urlpatterns = [
    ...
    path('api/players/<str:user_id>/', PlayerDetail.as_view(), name='player-detail'),
